...
from gateway.accounts.views import ROLE_SCOPES
from gateway.common.keys import get_kid, get_public_key_pem
...
def _decode_user_token(token: str) -> dict[str, object]:
    ...
    directly against the published public key here, same as gateway's own
