"""Tracks front-of-house's live `SPEED` so every domain-time sleep in this process
...
class SpeedTracker:
    def __init__(
        self, client: FrontOfHouseClient, *, poll_interval_seconds: float = 10.0, initial: int = 1
    ) -> None:
        self._client = client
