"""Verifies front-of-house-signed service tokens on every non-health endpoint.

Kitchen has exactly one caller this phase — front-of-house (SPEC.md §3.3's table
lists "front-of-house, board" for `/queue` and `/ovens`, but the board doesn't exist
...
needs, both minted per-call by `front_of_house.common.service_tokens`.
"""
