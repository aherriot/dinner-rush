...
from front_of_house.eventing.handlers import handle_analytics, handle_board_fanout, handle_ws_fanout
from front_of_house.eventing.models import EventTypeCounter, Outbox, ProcessedEvent
...
def isolated_stream(redis_client: redis_lib.Redis) -> Iterator[str]:
    ...
    the recovery *mechanics* against front-of-house's real handler, and using a
