...
the snapshot come from `WS /ws/board` (`front_of_house/eventing/consumers.py`)."""
...
from front_of_house.board.scenarios_config import (
    CONTROLLABLE_SCENARIOS,
    ScenarioActionConfig,
    ScenarioConfig,
    load_scenarios,
)
from front_of_house.board.serializers import (
...
from front_of_house.common.permissions import IsKitchenOrManager, IsManager
from front_of_house.orders import dispatch_client, kitchen_client
