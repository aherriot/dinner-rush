"""`make reset` — fast in-place reset for a fresh demo, front-of-house's half.
...
from front_of_house.board.scenario_state import OVERRIDE_SCENARIOS, clear_override
