...
from front_of_house.accounts.serializers import (
...
from front_of_house.accounts.speed import VALID_SPEEDS, get_speed, set_speed
...
from front_of_house.customers.serializers import CustomerSerializer

#: SPEC.md §6.1's resource matrix, encoded as scope strings. Front-of-house's own
...
#: front-of-house's role-to-permission mapping and shouldn't need one.
