...
test-fe: ## vitest + Playwright visual regression — lands in Phase 1
	@echo "make test-fe: not implemented yet — see PHASES.md Phase 1"
	@exit 1
...
storybook: ## lands in Phase 1
	@echo "make storybook: not implemented yet — see PHASES.md Phase 1"
	@exit 1
